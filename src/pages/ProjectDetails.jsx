  ...
  return (
    <div className="project-details-page">
      ...
      <div className="project-details-body">
        ...
        <section className="project-section">
          <h3>Payment</h3>
          <p>Use M-Pesa STK Push to pay for this project (test mode requires backend).</p>
          <MpesaPayment accountReference={`PRJ-${mockProject.id}`} transactionDesc={`Payment for ${mockProject.title}`} />
        </section>
